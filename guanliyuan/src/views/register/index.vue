  ...
  <div class="login-container">
    ...
    >
      ...
      <div class="agreed">
        ...
        <span class="agree-content">   <router-link to="/contract" target="_blank">《乐轮滑平台服务协议》</router-link></span>
...
// import { registerByUsername, getCode } from '@/api/register'
...
export default {
  ...
  methods: {
    ...
    get_code() {
      // if (
      //   !validateEmail(this.registerForm.username) &&
      //   !validatePhone(this.registerForm.username)
      // ) {
      //   this.$message.error('你输入的账号不合法')
      // } else {
      //   this.getCode.username = this.registerForm.username
